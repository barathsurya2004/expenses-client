...
const ICONS: Record<string, React.ReactNode> = {
  ...
  'receipt':   <><path d="M5 3h14v18l-3-2-3 2-3 2-3 2-3 2-2-2V3z"/><path d="M9 8h6M9 12h6M9 16h3"/></>,
};
...
export const LucideIcon: React.FC<LucideIconProps> = ({ name, size = 20, stroke = 1.6, style, color }) => {
