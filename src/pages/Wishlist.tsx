...
import { Card, SectionLabel, ProgressBar, PageHeader, AnimatedRupees, AnimatedInt } from '../components/Common';
...
interface WishlistProps {
  ...
  onAllocate: (item: WishlistItem) => void;
}

export const Wishlist: React.FC<WishlistProps> = ({ state, onAdd, onOpen, onAllocate }) => {
        ...
        <Card padding={20}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <LucideIcon name="wallet" size={16} stroke={2} />
            </div>
      ...
      <div style={{ padding: '4px 16px 0', display: 'flex', flexDirection: 'column', gap: 10 }}>
        <SectionLabel action={
          <span className="press" onClick={() => onAdd()} style={{
            ...
            <LucideIcon name="plus" size={14} stroke={2.4} />
            New
          </span>
...
function WishlistCard({ item, onOpen, onAllocate, canAllocate }: WishlistCardProps) {
      ...
      <div style={{ display: 'flex', alignItems: 'stretch' }} onClick={onOpen} className="press">
        ...
        <div style={{
          ...
          {item.image ? (
            ...
            <div style={{
              ...
              <LucideIcon name="image" size={24} stroke={1.6} />
            </div>
          )}
        </div>
        ...
        <div style={{ flex: 1, padding: '14px 14px 14px 14px', minWidth: 0 }}>
          ...
          <div style={{
            ...
            {funded
              ? <><LucideIcon name="check" size={12} stroke={2.5} /> Ready to buy</>
              : <><LucideIcon name="clock" size={12} /> {eta}</>
            }
          </div>
      ...
      {!funded && (
        <div style={{
          ...
          <div onClick={onOpen} className="press" style={{
            ...
            <LucideIcon name="arrow-up-right" size={13} stroke={2.2} /> Details
          </div>
          ...
          <div onClick={(e) => { e.stopPropagation(); if (canAllocate) onAllocate(); }}
            ...
            <LucideIcon name="plus" size={13} stroke={2.6} /> Allocate
          </div>
        </div>
      )}
    </Card>
