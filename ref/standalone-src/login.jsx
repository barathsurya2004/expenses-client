...
function LoginScreen({ onSignIn }) {
  const [name, setName] = lUseState('');
  const [email, setEmail] = lUseState('');
  const [showEmail, setShowEmail] = lUseState(false);
    ...
    <div className="phone-scroll fade-up" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Lucide name="wallet" size={42} stroke={1.6} />
        </div>
      ...
      <div style={{ padding: '0 22px 18px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        <Card padding={0}>
          <div style={{
            ...
            <Lucide name="pencil" size={18} style={{ color: 'var(--ink-3)' }} />
          ...
          {showEmail && (
            <>
              ...
              <div style={{
                ...
                <Lucide name="bell" size={18} style={{ color: 'var(--ink-3)' }} />
